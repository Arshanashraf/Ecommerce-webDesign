    ...
    <header className="bg-white shadow w-full 2xs:pb-2">
            ...
            <nav className=" -mt-3 w-full px-0 sm:hidden xs:hidden md:hidden lg:hidden xl:hidden 2xl:hidden 3xl:hidden">
                ...
                <div className="space-x-2 mx-4 mb-2">
                    <a href="/products" className="text-sm text-blue-500 bg-gray-300 rounded-md px-2 py-1">All category</a>
                    <a href="/products" className="text-sm text-blue-500 bg-gray-300 rounded-md px-2 py-1">Gadget</a>
                    <a href="/products" className="text-sm text-blue-500 bg-gray-300 rounded-md px-2 py-1">Clothes</a>
                    </div>
            </nav>
            <nav className="border-t  border-black w-full px-0 2xs:hidden">
                ...
                <nav 
                   ...
                   className={`absolute flex flex-col space-y-2 mt-8 shadow-lg rounded-lg shadow-gray-600 bg-white ${
                    ...
                    <a href="/products" className="hover:bg-blue-100 px-3 py-1">Sports and outdoor</a>
                    <a href="/products" className="hover:bg-blue-100 px-3 py-1">Animal and pets</a>
                    <a href="/products" className="hover:bg-blue-100 px-3 py-1">Machinery tools</a>
                    <a href="/products" className="hover:bg-blue-100 px-3 py-1">More categories</a>
                    </nav>
